...
public class ObjectNode
{
     ...
     **/
    // Pre-Post conditions:
    // Precondition: source != null && source.data != null
    // Postcondition: The method will return an ObjectNode representing the head of the copied list
    //                The data and links of each node in the copied list will be replicas of all the
    //                ObjectNodes linked by the orginal source node that was passed to the method.
    ...
    //                The data and links of each node in the copied list will be replicas of all the
    //                ObjectNodes linked by the orginal source node that was passed to the method.
    //                A null source node will result in a null return.
    // Runtime for method below
    // Big-O: O(n)
    // Big-Omega: Omega(n)
    // Big-Theta:  Theta(n)
     ...
     **/
    // Precondition: source != null && source.data != null
    // Postcondition: The method will return an ObjectNode array of length 2 representing the head and tail
    //                of the copied list.
    //                The data and links of each node in the copied list will be replicas of all the
    //                ObjectNodes linked by the orginal source node that was passed to the method.
    //                A null source will result in an empty array being returned
